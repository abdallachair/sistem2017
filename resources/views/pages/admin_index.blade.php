...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="article_edit">
            ...
            <a href="{{ URL::to('/sistem-admin/admin_article') }}" class="text-center"><img class="user-image img-responsive" style="width: 50%;" src="src/img/1.png"></a>
        </div>
    </div>
    <div class="col-md-3"></div>
</div>
...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="repository_edit">
            ...
            <a href="{{ URL::to('/sistem-admin/admin_repository') }}" class="text-center"><img class="user-image img-responsive" style="width: 50%;" src="src/img/2.png"></a>
        </div>
    </div>
    <div class="col-md-3"></div>
</div>
